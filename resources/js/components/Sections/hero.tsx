...
import {  Download, FacebookIcon, Github, Linkedin, Twitter } from 'lucide-react';
            ...
            <div className='flex flex-col md:flex-row items-center'>
                ...
                <div className='md:w-1/2 mb-12 md:mb-0'>
                    ...
                    <div className="flex flex-wrap mt-8 items-center gap-4 mb-16 md:mb-0">
                        <button className="flex items-center gap-2 text-purple-600 font-semibold border-1 border-purple-600 hover:text-white hover:bg-purple-600 rounded-3xl py-2 px-4">
                        ...
                        <div className='flex space-x-4'>
                            <button className='border-1 border-purple-600 hover:bg-purple-600 rounded-full px-2 py-2'><Github className="w-4 h-4 text-purple-600 hover:text-white" /></button>
                            <button className='border-1 border-purple-600 hover:bg-purple-600 rounded-full px-2 py-2'><Linkedin className="w-4 h-4 text-purple-600 hover:text-white" /></button>
                            <button className='border-1 border-purple-600 hover:bg-purple-600 rounded-full px-2 py-2'><Twitter className="w-4 h-4 text-purple-600 hover:text-white" /></button>
                            <button className='border-1 border-purple-600 hover:bg-purple-600 rounded-full px-2 py-2'><FacebookIcon className="w-4 h-4 text-purple-600 hover:text-white" /></button>
                        </div>
                    </div>
                    </motion.div>
                </div>
